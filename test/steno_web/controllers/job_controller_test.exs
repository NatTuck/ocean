defmodule StenoWeb.JobControllerTest do
  use StenoWeb.ConnCase

  alias Steno.Jobs

  @create_attrs %{desc: "some desc", key: "some key", output: "some output", user: "some user"}
  @update_attrs %{desc: "some updated desc", key: "some updated key", output: "some updated output", user: "some updated user"}
  @invalid_attrs %{desc: nil, key: nil, output: nil, user: nil}
